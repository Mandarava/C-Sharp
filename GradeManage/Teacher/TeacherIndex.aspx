<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeacherIndex.aspx.cs" Inherits="Teacher_TeacherIndex" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>欢迎光临老师子系统</title>
</head>
	<frameset rows="87,*,26" cols="*" framespacing="0" border="0" frameborder="no">
		...
		<frameset id="attachucp" rows="*" cols="129,*" framespacing="0" frameborder="no" border="0">
			<frame src="TeacherLeft.aspx" name="LeftMenu" scrolling="auto">
