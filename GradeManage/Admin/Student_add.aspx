            ...
            <tr>
                ...
                <td align="center" class="tr-openwindow-bgcolor">
                    ...
                    <asp:TextBox ID="tbx_name" runat="server" Width="139px"></asp:TextBox></td>
                        ...
                        <tr class="tr-openwindow-show">
                            <td align="right" style="height: 19px" width="20%">
                                初始密码：</td>
                            <td align="left" class="td-openwindow-show" style="width: 30%; height: 19px">
                    <asp:TextBox ID="tbx_pwd1" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr class="tr-openwindow-show">
                            <td align="right" style="height: 19px" width="20%">
                                确认：</td>
                    ...
                    <asp:TextBox ID="tbx_pwd2" runat="server"></asp:TextBox>
                                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="tbx_pwd1" ControlToValidate="tbx_pwd2" ErrorMessage="两次密码不一致"></asp:CompareValidator>
                            </td>
                        </tr>
                        <tr class="tr-openwindow-show">
                            <td align="right" style="height: 19px" width="20%">
                    专业：</td>
                            <td align="left" class="td-openwindow-show" style="width: 30%; height: 19px">
                                <asp:TextBox ID="tbx_major" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr class="tr-openwindow-show">
                            <td align="right" style="height: 19px" width="20%">
                                学院：</td>
                            <td align="left" class="td-openwindow-show" style="width: 30%; height: 19px">
                                <asp:TextBox ID="tbx_dept" runat="server"></asp:TextBox></td>
                        </tr>
                    </table>
                </td>
